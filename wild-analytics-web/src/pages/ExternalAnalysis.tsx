...
export default function ExternalAnalysis() {
  ...
  return (
    <div style={{
      ...
      {/* Form */}
      <div className="external-analysis-form" style={{
        background: 'white',
        padding: '30px',
        borderRadius: '20px',
        ...
        <div className="external-form-row" style={{ marginTop: '10px' }}>
          <input
            type="text"
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            placeholder="Введите артикул товара или ключевое слово"
            className="external-article-input"
          />

          <button
            onClick={analyzeExternal}
            disabled={loading}
            className="external-analyze-button"
          >
