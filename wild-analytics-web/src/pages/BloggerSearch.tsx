...
const BloggerSearch: React.FC = () => {
  ...
  return (
    <div className="blogger-search-container" style={{ 
      minHeight: '100vh', 
      background: 'linear-gradient(135deg, #f0f9ff 0%, #e0e7ff 100%)',
      padding: '20px 0'
    }}>
      <div className="blogger-search-content" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 20px' }}>
        {/* Заголовок */}
        <div className="blogger-search-header" style={{
          background: 'white',
          borderRadius: '20px',
          padding: '30px',
          ...
          {/* Форма поиска */}
          <div className="blogger-search-form" style={{
            display: 'grid',
          ...
          <button
            className="blogger-search-button"
        ...
        {data && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            {/* Общая аналитика */}
            <div className="blogger-analytics" style={{
              background: 'white',
              borderRadius: '20px',
              padding: '30px',
              boxShadow: '0 10px 30px rgba(0,0,0,0.1)'
              ...
              <div className="blogger-analytics-grid" style={{
                display: 'grid',
                gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))',
                gap: '20px',
                marginBottom: '30px'
              ...
              {/* Графики */}
              <div className="blogger-charts-grid" style={{
                display: 'grid',
                gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))',
                gap: '30px'
              }}>
                {platformChart && (
                  <div className="blogger-chart-card" style={{ height: '300px' }}>
            ...
            {/* AI Рекомендации */}
            <div className="blogger-ai-recommendations" style={{
              background: 'white',
              borderRadius: '20px',
              padding: '30px',
              boxShadow: '0 10px 30px rgba(0,0,0,0.1)'
              ...
              <div className="blogger-recommendations-grid" style={{
                display: 'grid',
                gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))',
                gap: '25px'
              }}>
                {/* Лучшие блогеры */}
                <div className="blogger-recommendation-card blogger-best-bloggers" style={{
                ...
                {/* Платформы */}
                <div className="blogger-recommendation-card blogger-platforms" style={{
                ...
                {/* Бюджетная стратегия */}
                <div className="blogger-recommendation-card blogger-budget-strategy" style={{
                ...
                {/* Контент */}
                <div className="blogger-recommendation-card blogger-content-types" style={{
                ...
                <div className="blogger-recommendation-card blogger-negotiation-tips" style={{
                ...
                {/* ROI */}
                <div className="blogger-recommendation-card blogger-roi" style={{
            ...
            <div className="blogger-filters" style={{
              background: 'white',
              borderRadius: '20px',
              padding: '20px 30px',
              boxShadow: '0 10px 30px rgba(0,0,0,0.1)',
              ...
              <button
                className="blogger-export-button"
              ...
              <div className="blogger-results-count" style={{ marginLeft: 'auto', fontWeight: '600', color: '#6b7280' }}>
                Показано: {filteredBloggers.length} из {data.total_found}
              </div>
            </div>

            {/* Карточки блогеров */}
            <div className="blogger-cards-grid" style={{
              display: 'grid',
