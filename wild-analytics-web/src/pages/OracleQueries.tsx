  ...
  return (
    <div style={{ 
      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto', padding: '0 20px' }}>
        {/* Заголовок */}
        <div className="oracle-form" style={{
          background: 'white',
          borderRadius: '20px',
          padding: '30px',
          ...
          {/* Параметры анализа */}
          <div className="oracle-form-grid" style={{
            display: 'grid',
          ...
          <button
            className="oracle-analyze-button"
        ...
        {data && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            ...
            <div style={{
              ...
              <div className="oracle-tabs" style={{ display: 'flex', gap: '10px' }}>
              ...
              <div className="oracle-count" style={{ marginLeft: 'auto', fontWeight: '600', color: '#6b7280' }}>
            ...
            {activeTab === 'charts' && (
              <div style={{
                ...
                <div className="oracle-charts-grid" style={{
                  display: 'grid',
                  gridTemplateColumns: 'repeat(auto-fit, minmax(500px, 1fr))',
                  gap: '40px'
                }}>
                  {revenueChart && (
                    <div className="oracle-chart-card" style={{ 
                      height: '400px',
                      background: 'linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%)',
                      borderRadius: '15px',
                      padding: '20px',
            ...
            <div style={{
              ...
              <div className="oracle-categories-grid" style={{
                display: 'grid',
            ...
            {activeTab === 'queries' && (
              <div style={{
                ...
                <div className="oracle-queries-table" style={{ overflowX: 'auto' }}>
                  <table style={{
                    width: '100%',
                      ...
                      {sortedQueries.map((query, index) => (
                        ...
                        >
                          ...
                          <td style={{ padding: '12px', textAlign: 'center' }}>
                            <div className="dynamics-cell" style={{
                              display: 'flex',
                              flexDirection: 'column',
                              alignItems: 'center',
                              gap: '3px'
                          ...
                          <td style={{ padding: '12px' }}>
                            <div className="sparkline-chart" style={{ height: '40px', width: '100px' }}>
                              <Line 
