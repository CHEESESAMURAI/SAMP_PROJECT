...
const SupplyPlanningEnhanced: React.FC = () => {
  ...
  const renderCharts = () => {
    ...
    return (
      <div className="supply-charts-grid" style={{ 
        display: 'grid', 
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.2)', marginBottom: '20px' }}>
          <div className="supply-tabs-container" style={{ display: 'flex', borderBottom: '1px solid #e5e7eb' }}>
            <button
              className={`supply-tab-button ${activeTab === 0 ? 'active' : ''}`}
            ...
            <button
              className={`supply-tab-button ${activeTab === 1 ? 'active' : ''}`}
            ...
            <button
              className={`supply-tab-button ${activeTab === 2 ? 'active' : ''}`}
          ...
          <div style={{ padding: '30px' }}>
            ...
            {activeTab === 0 && (
              <div>
                <div className="supply-form-grid" style={{ 
                  display: 'grid', 
